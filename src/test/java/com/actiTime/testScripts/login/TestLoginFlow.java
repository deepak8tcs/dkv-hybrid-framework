...
public class TestLoginFlow extends TestBase{
	...
	public void testLogin() throws Exception{
		...
		//loginPage = PageFactory.initElements(driver, LoginPage.class);
		boolean isLoginSuccessful=loginPage.loginToApplication(properties.getUsername(),properties.getPassword());
		Assert.assertTrue(isLoginSuccessful, "Login is not successful");
	}
	...
	//	extentTest = extent.startTest("verify logout");
		...
		Assert.assertTrue(isLogoutSuccessful, "Logout is not successful");		
	}
